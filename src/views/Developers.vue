  ...
  <div>
    ...
    <div class="p-4 after-header">
      <div class="container-sm mx-auto mb-4">
        <p class="mb-4">
          You’ve found the SmokeConnect developer documentation! This page dedicated to showing you
          all the ways that you can use SmokeConnect to make cool stuff.
        </p>
        <a
        ...
        <div v-if="selectedSection === 'new-app'" class="mb-4">
          <div class="mb-3">
            <p>
              To create a new app on SmokeConnect you need a Smoke account for it. If you don't have
              one yet you can create one on
              <a href="https://smoke.io" target="_blank">smoke.io</a>. Once you
              have a Smoke account for your app, click on the button below, log in with your app
          ...
          <p>
            If you would like to use the OAuth 2 API for posting with SmokeConnect server you need
            to authorize the Smoke account "smokeconnect" to post on the behalf of your app account.
            <router-link to="/authorize/smokeconnect">Click here</router-link>
        ...
        <div v-if="selectedSection === 'sdk'" class="mb-4">
          <p>
            Get started integrating SmokeConnect on your website with SmokeConnect.js, the official
            JavaScript SDK.
          </p>
          <p>
            <a href="https://github.com/herbncrypto/smokeconnect.js" target="_blank"
              ><span class="iconfont icon-mark-github" /> SmokeConnect.js</a
            >
          </p>
        </div>
        <a
        ...
        <div v-if="selectedSection === 'demo'" class="mb-4">
          <p class="mt-2">Checkout SmokeConnect demo with Vue.js</p>
          <p><a href="https://demo.smokeconnect.com" target="_blank" class="mr-2">Try demo</a></p>
          <p>
            <a
              href="https://github.com/herbncrypto/smokeconnect.js/blob/master/docs/index.html"
              target="_blank"
            >
        ...
        <div v-if="selectedSection === 'oauth2'" class="mb-4">
          ...
          <p>
            ...
            https://api.smokeconnect.com/api/oauth2/authorize
          </p>
          <p>
            <b>Token URL</b><br />
            https://api.smokeconnect.com/api/oauth2/token
          </p>
          <p>
            <b>Revocation URL</b><br />
            https://api.smokeconnect.com/api/oauth2/token/revoke
          </p>
        </div>
        <a
